...
SECRET_KEY = 'django-insecure-*o(s+=m_pt(4d*z=jrf$wd((&p#=#9fnz2t_($i-xcz#z=rl_j'
...
WSGI_APPLICATION = 'XCollege.wsgi.application'
...
# Define the static root directory for collecting static files during deployment
